                ...
                <div className="bg-white rounded-lg shadow-md p-8 mb-8 max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-gray max-w-none">
                        <p className="text-gray-700 leading-relaxed mb-4">
                            I am a software developer with focused, practical experience at the intersection of robotics, artificial intelligence, and cloud computing. Proficient in Python and C#, I have delivered solutions from proof-of-concept to production deployment across corporate and research environments. My experience includes internships at ABB Robotics and Netradyne, research contributions at the Indian Institute of Science (IISc), and current graduate research at USC's Dynamic Robots and Control Laboratory, where I am developing real-time vision pipelines (SAM2, YOLO, OWL-ViT) on Jetson hardware integrated with ROS2 for autonomous robots.
                        </p>
                        <p className="text-gray-700 leading-relaxed">
                            At ABB, I independently developed a Voice Assistance Middleware in C#/.NET for collaborative robots; at Netradyne, I designed and deployed a Python-based monitoring tool that reduced manual QA analysis time by 40–50%; and in undergraduate research, I achieved 93.66% accuracy in lung cancer metastasis detection using ensemble learning. I bring proven ability to work independently on prototypes as well as collaboratively on cross-functional, production-ready systems, and I am seeking an internship to apply my skills in robotics, vision, and software engineering to solve challenging problems.
                        </p>
                    </div>
                </div>
