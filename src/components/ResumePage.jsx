                ...
                <div className="bg-white rounded-lg shadow-md p-8 mb-8 max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-gray max-w-none">
                        <p className="text-gray-700 leading-relaxed mb-4">
                            I am a software developer with focused, practical experience at the intersection of robotics, artificial intelligence, and cloud computing. Proficient in both Python and C#, I have successfully developed solutions from proof-of-concept to production deployment in both corporate and research environments. My background includes internships at ABB Robotics and Netradyne, research contributions at the Indian Institute of Science (IISc), and a comprehensive undergraduate project in machine learning.
                        </p>
                        <p className="text-gray-700 leading-relaxed">
                            My core competencies are demonstrated through key projects that delivered measurable impact: at ABB Robotics, I independently developed a Voice Assistance Middleware in C#/.NET for collaborative robots; at Netradyne, I designed and deployed a Python-based automated monitoring tool that reduced manual analysis time by 40-50%; and my undergraduate research achieved 93.66% accuracy in lung cancer metastasis detection using ensemble learning. I have proven experience working independently on proofs-of-concept and collaborating within cross-functional teams to deliver production-ready solutions, currently seeking an internship where I can apply my skills in robotics, machine learning, and software engineering to solve challenging problems.
                        </p>
                    </div>
                </div>
